...
**Release v0.2.0** · **English** · [Español](README.es.md) · [Changelog](CHANGELOG.md)
...
Runtime requirements: Herdr 0.9.1+ and Node 22+. Plugin v0.2.0 supports macOS and Linux; Windows is
...
## 2. Install LCARS for Herdr v0.2.0
